...
MEMORY
    ...
    SRAM1 ( rw ) : ORIGIN = (536870912), LENGTH = (262144) SRAM2 ( rw ) : ORIGIN = (537133056), LENGTH = (65536) SRAM3 ( rw ) : ORIGIN = (537198592), LENGTH = (327680)
...
blink_driver_api_area : { _blink_driver_api_list_start = .; KEEP(*(SORT_BY_NAME(._blink_driver_api.static.*))); _blink_driver_api_list_end = .;; } > FLASH
